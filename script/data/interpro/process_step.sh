...
python src/data/interpro/filter_no_structure_fasta.py \
...
python src/data/interpro/filter_repeat_fasta.py \
    --interpro_keyword_dir data/interpro_2503/${interpro_keyword}

# step 4: label site fasta
python src/data/interpro/label_site_fasta.py \
    --interpro_keyword_dir data/interpro_2503/${interpro_keyword}

# step 5: merge the label within a sequence
python src/data/interpro/label_merge.py \
    --interpro_keyword_dir data/interpro_2503/${interpro_keyword}
